...
func (m *mockUserRepo) GetByID(ctx context.Context, id uint) (*domain.Entity, error) { return nil, repo.ErrNotFound }
func (m *mockUserRepo) GetByEmail(ctx context.Context, email string) (*domain.Entity, error) { return nil, repo.ErrNotFound }
func (m *mockUserRepo) List(ctx context.Context, limit, offset int) ([]domain.Entity, error) { return nil, nil }
